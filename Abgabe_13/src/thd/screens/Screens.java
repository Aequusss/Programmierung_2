...
public class Screens {
     ...
     * @param fontName  Name der Schriftart, die für die Anzeige verwendet werden soll.
     * @return String des Buttons, den der User gewählt hat, also "Einfach" oder "Standard".
     */
    public static String showStartScreen(GameView gameView, String title, String description, String preset, String fontName) {
        StartScreen startScreen = new StartScreen(gameView, title, description, preset, fontName);
     ...
     * @param fontName  Name der Schriftart, die für die Anzeige verwendet werden soll.
     */
    public static void showEndScreen(GameView gameView, String message, String fontName) {
        EndScreen endScreen = new EndScreen(gameView, message, fontName);
        gameView.clearKeyEvents();
    ...
    private static class StartScreen extends Screen {
        ...
        private StartScreen(GameView gameView, String title, String description, String preset, String fontName) {
            ...
            simpleBoxes.add(new SimpleBox("Einfach", x, y, boxWidth, boxHeight, fontName));
            simpleBoxes.add(new SimpleBox("Standard", x + boxWidth + gap, y, boxWidth, boxHeight, fontName));
            simpleBoxes.add(new SimpleBox("Beenden", x + 2 * boxWidth + 2 * gap, y, boxWidth, boxHeight, fontName));
        ...
        private void addTitle() {
            ...
            gameView.addTextToCanvas(title, x, gap, titleFontSize, true, titleColor, 0, fontName);
        }
        ...
        private void addDescription() {
            ...
            gameView.addTextToCanvas(description, x, y, fontSize, false, Color.WHITE, 0, fontName);
        }
    ...
    private static class EndScreen extends Screen {
        ...
        private EndScreen(GameView gameView, String message, String fontName) {
            ...
            int y = GameView.HEIGHT - boxHeight - gap;
            ArrayList<SimpleBox> simpleBoxes = new ArrayList<>(3);
            simpleBoxes.add(new SimpleBox("Neues Spiel", x, y, boxWidth, boxHeight, fontName));
            simpleBoxes.add(new SimpleBox("Beenden", x + boxWidth + gap, y, boxWidth, boxHeight, fontName));
            setSimpleBoxes(simpleBoxes, 0);
        }
        ...
        private void addMessage() {
            ...
            gameView.addTextToCanvas(message, x, y, fontSize, false, Color.WHITE, 0, fontName);
        }
    ...
    private static class SimpleBox extends Rectangle {
        ...
        private SimpleBox(String text, int x, int y, int width, int height, String fontName) {
        ...
        private void addToCanvas(GameView gameView) {
            ...
            gameView.addTextToCanvas(text,
                    ...
                    y + (height - fontSize * 3 / 2d) / 2d, fontSize, true, Color.WHITE, 0, fontName);
        }
    }
}