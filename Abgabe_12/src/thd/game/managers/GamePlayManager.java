...
import thd.gameobjects.unmovable.GroundRocketTunnel;
...
public class GamePlayManager extends WorldShiftManager {
     ...
     */
    protected static final long LEVEL_DURATION_MS = 20_000;
    /**
    ...
    /**
     * Destroys all enemies and enemy projectiles on the screen (Shield Nuke effect).
     */
    public void nukeScreen() {
        ...
        for (GameObject obj : currentObjects) {
            if (obj instanceof EnemyTank || obj instanceof EnemyHelicopter
                    || obj instanceof ArmoredAAGun || obj instanceof GroundRocketTunnel
                    || obj instanceof GroundRocket || obj instanceof EnemyBullet) {
