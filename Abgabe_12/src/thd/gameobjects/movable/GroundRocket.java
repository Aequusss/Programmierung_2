 ...
 */
public class GroundRocket extends CollidingGameObject implements ShiftableGameObject {
     ...
     */
    public GroundRocket(GameView gameView, GamePlayManager gamePlayManager, double x, double y) {
    ...
    public void addToCanvas() {
        gameView.addBlockImageToCanvas(SilkwormBlockImages.GROUND_ROCKET_IMAGE, position.getX(), position.getY(), size, distanceToBackground);
    }
