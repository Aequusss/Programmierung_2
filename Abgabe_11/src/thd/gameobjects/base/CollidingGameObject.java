...
public abstract class CollidingGameObject extends GameObject {
     ...
     *
     * @param offsets the {@link HitBoxOffsets} containing the hitbox offset values
     */
    protected void hitBoxOffsets(HitBoxOffsets offsets) {
        this.hitBoxOffsetX = offsets.offsetX();
        this.hitBoxOffsetY = offsets.offsetY();
        this.hitBoxOffsetWidth = offsets.offsetWidth();
        this.hitBoxOffsetHeight = offsets.offsetHeight();
    }
