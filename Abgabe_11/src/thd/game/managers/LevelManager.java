...
class LevelManager extends GameWorldManager {
    ...
    protected void initializeGame() {
        ...
        currentLevelIndex = 0;
        level = levels.get(0);
        lives = (Level.difficulty == Difficulty.EASY) ? 15 : LIVES;
        points = 0;
        weaponLevel = 1;
    ...
    protected void initializeLevel() {
        ...
        gameView.preloadSound("shoot.wav");
        gameView.preloadSound("enemyshoot.wav");
        gameView.preloadSound("explosion.wav");
        gameView.preloadSound("pickup.wav");
        gameView.preloadSound("hit.wav");
        gameView.preloadSound("levelstart.wav");

        gameView.playSound("levelstart.wav", false, 0.8f);
